"""basic conv + relu + pool forward pass - real NumPy implementation."""
import numpy as np
...
def build_pipeline(image_path=None, **kwargs):
    ...
    return {'steps': [
        {'id': 'input', 'name': 'Input', 'image': _b64(img),
         'explanation': 'cnn_basics feature extraction.'},
        ...
        'algorithm': 'cnn_basics', 'gradient_mean': round(float(mag.mean()), 4)}}
