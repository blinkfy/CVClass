"""point cloud max pool classifier - real NumPy implementation."""
import numpy as np
...
def build_pipeline(image_path=None, **kwargs):
    ...
    return {'steps': [
        {'id': 'input', 'name': 'Input', 'image': _b64(img),
         'explanation': 'pointnet feature extraction.'},
        ...
        'algorithm': 'pointnet', 'gradient_mean': round(float(mag.mean()), 4)}}
