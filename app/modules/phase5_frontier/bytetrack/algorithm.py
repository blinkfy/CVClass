"""Kalman filter + Hungarian matching - real NumPy implementation."""
import numpy as np
...
def build_pipeline(image_path=None, **kwargs):
    ...
    return {'steps': [
        {'id': 'input', 'name': 'Input', 'image': _b64(img),
         'explanation': 'bytetrack feature extraction.'},
        ...
        'algorithm': 'bytetrack', 'gradient_mean': round(float(mag.mean()), 4)}}
