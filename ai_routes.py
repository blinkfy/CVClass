...
def register_ai_routes(app, get_ai_config):
    ...
    navigation_catalog = [
        ...
        {"path": "/object-detection/yolo", "label": "YOLO 推理与 NMS", "group": "分割与识别任务", "keywords": ["yolo", "onnx", "nms", "confidence", "iou", "candidate boxes"]},
        {"path": "/object-detection/rcnn", "label": "R-CNN 系列机制", "group": "分割与识别任务", "keywords": ["r-cnn", "fast r-cnn", "faster r-cnn", "rpn", "anchor", "roi pooling"]},
